      ...
      <div className="hero min-h-[calc(100vh-3.3rem)] pt-16 bg-base-200">
        <div className="card flex-shrink-0 shadow-2xl bg-base-100">
          <div className="card-body px-3 md:p-14 md:gap-5">
            <h2 className="text-center text-xl xs:text-4xl md:text-5xl font-bold">
              Login
            </h2>
            ...
            <label className="label justify-end mt-3">
              <Link
                to="/sign-up"
                className="label-text-alt link link-hover md:mt-2 text-base"
              >
                Create Account
              </Link>
            </label>
            ...
            <div className="flex flex-col gap-7">
              ...
              <button
                className="btn w-1/3 m-auto btn-sm text-xs xs:btn-md"
                onClick={googleLogin}
              >
                Google
              </button>
